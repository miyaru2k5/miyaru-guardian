...
const ContactFacebookPage: React.FC = () => {
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-xs text-gray-500 truncate group-hover:text-primary transition-colors">{normalizeContactUrl(item.contact_url)}</p>
                </div>
              </div>
