        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col gap-2">
              <a href={`tel:${footer.contact.phone.replace(/\./g, "")}`} className="text-sm text-muted-foreground hover:text-primary transition-colors">
                Phone: {footer.contact.phone}
              </a>
              <a href={`mailto:${footer.contact.email}`} className="text-sm text-muted-foreground hover:text-primary transition-colors">
